...
<section class="portfolio_section sec_ptb_120 clearfix">
        ...
        <div class="row" style="float: right;padding-right: 45px;">
            <div class="">
                <div class="select_option mb-0">
                    <div class="nice-select" tabindex="0"><span class="current">Social Ads</span>
                        <ul class="list">
						
                            <li data-value="1" class="option"><a href="https://designlyworld.com/identity/">Identity</a></li>
                             <li data-value="2" class="option"><a href="https://designlyworld.com/packaging/">Packaging</a></li>
                             <li data-value="3" class="option"><a href="https://designlyworld.com/brochure-catalogue/">Brochure & Catalogue</a></li>
                             <li data-value="4" class="option"><a href="https://designlyworld.com/flyers-posters/">Flyers & Posters</a></li>
    ...
    <div class="gallerycontainer">
        <div class="gallery-item">
            <!-- Social Ads -->
            <?php if( have_rows('Ads','options') ):?>
            <?php while( have_rows('Ads','options') ) : the_row();
